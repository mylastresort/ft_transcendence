...
export const Get_Not_Friends = () => {
  ...
  return request
    .get('/api/v1/friends/Users-Not-Friends')
...
export const PostCancelFriendRequest = (body: any) => {
  const jwtToken = localStorage.getItem('jwtToken');
  return request
    .post('/api/v1/friends/CancelFriendRequest')
    .set('Authorization', `Bearer ${jwtToken}`)
    .send(body)
    .then((res) => {
      return res;
...
export const GetFriendRequests = () => {
  const jwtToken = localStorage.getItem('jwtToken');
  return request
    .get('/api/v1/friends/GetFriendRequests')
    .set('Authorization', `Bearer ${jwtToken}`)
    .then((res) => {
      return res;
    })
...
export const PostAcceptFriendRequest = (body: any) => {
  const jwtToken = localStorage.getItem('jwtToken');
  return request
    .post('/api/v1/friends/AcceptFriendRequest')
    .set('Authorization', `Bearer ${jwtToken}`)
    .send(body)
    .then((res) => {
      return res;
...
export const GetFriendsList = (body: any) => {
  const jwtToken = localStorage.getItem('jwtToken');
  return request
    .post('/api/v1/friends/GetFriends')
    .set('Authorization', `Bearer ${jwtToken}`)
    .send(body)
    .then((res) => {
      return res;
...
export const GetBLockedFriends = () => {
  const jwtToken = localStorage.getItem('jwtToken');
  return request
    .get('/api/v1/friends/GetBlockedUsers')
    .set('Authorization', `Bearer ${jwtToken}`)
    .then((res) => {
      return res;
    })
...
export const PostUnblock = (body: any) => {
  const jwtToken = localStorage.getItem('jwtToken');
  return request
    .post('/api/v1/friends/UnblockUser')
    .set('Authorization', `Bearer ${jwtToken}`)
    .send(body)
    .then((res) => {
      return res;
